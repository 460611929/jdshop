...
<title>ShearPhoto2.1修正版_支持HTML5头像截取工具_JS截图_切图插件_数码照片压缩截图插件_商品图片编辑_在线拍照截图</title>
<link href="/jdshop/Public/shearphoto_common/css/ShearPhoto.css" rel="stylesheet" type="text/css" media="all"><!--CSS文件，有点废话-->
<script  type="text/javascript" src="/jdshop/Public/shearphoto_common/js/ShearPhoto.js" ></script><!--ShearPhoto的核心文件 截取，拖拽，HTML5切图，数据交互等都是由这个文件处理，全部由明哥先生汗水交织而成-->
<script  type="text/javascript"  src="/jdshop/Public/shearphoto_common/js/webcam_ShearPhoto.js" ></script> <!--在线拍照那个FLASH的接口，非技术性文件-->
<script  type="text/javascript"  src="/jdshop/Public/shearphoto_common/js/alloyimage.js" ></script>   <!--图片特效处理,他只负责特效，其他功能与这个文件完全无关，这个JS从腾讯AI文件  如你不要特效的话，顺带删除这个文件，在hendle.js设置关闭特效-->
<script  type="text/javascript"  src="/jdshop/Public/shearphoto_common/js/handle.js" ></script>    <!--设置和处理对象方法的JS文件，要修改设置，请进入这个文件 -->
</head>
<body>
     ...
     <!--main范围开始-->
        <div id="main">
           <div class="point">
                ...
                <input name="shearphoto" type="hidden" value="我要在这里传参数"> <!--示例传参数到服务端，后端文件UPLOAD.php用$_POST['shearphoto']接收-->
