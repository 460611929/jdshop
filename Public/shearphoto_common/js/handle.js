...
window.ShearPhoto.MINGGE(function () {
    ...
    var relativeUrl = "/jdshop/Public/shearphoto_common"; //你不要在后面加斜杠，系统会自动给你加上斜杠，不信看下面！   index.html的JS引用路径自己改，很简单的说
    ...
    /*
     ...
     shearphoto.html 所在的目录位置   与 shearphoto/file 之间的相对目录
     这样讲好像你们不太明白?
     -----------------------------------------------------------------------------
     示例1：假如：index.htm        位于  http://xxx.com/abc/shearphoto.html
     shearphoto/file  则位于  http://xxx.com/abc/shearphoto/file
     那么relativeUrl就要写成    relativeUrl:"shearphoto"
     -----------------------------------------------------------------------------
     示例2：假如：index.htm        位于  http://xxx.com/abc/shearphot/def/shearphoto.html
     shearphoto/file  则位于  http://xxx.com/abc/shearphoto/file
