...
$ShearPhoto["config"] = array(
    ...
    "proportional" => 1 / 1,//比例截图，JS端也要相应设置哦，不然系统会给你抱出错误,不设比例填0，如填比例 ：3/4  代表宽和高的比例是3/4(3除以4的意思懂吗，菜菜，你可直接填0.75，没错)

    "quality" => 100,// 截图质量，0为一般质量（质量大概75左右），  0-100可选 ！ 整数型，质量超高，越清淅，缺点是文件体积越大，不是太严格追求图片高清，设0就可以,提示：PNG图片不带此效果
    ...
    "width" => array(//自定义设置生成截图的张数，大小，在这设，看好下面！
        ...
        array(70, true, "small")//你可以继续增加多张照片
    ),
